...
Test Case 1:
Sample Input: 4 2 6 9 7 5

Sample Output: 2 4 6 5 7 9

Test Case 2:
sample input: 9 8 7 6 5 4 3 2 1

sample output: 2 4 6 8 1 3 5 7 9

Level: Medium
Hints:
Create two empty arrays to hold even numbers and odd numbers. Iterate through the input array and distribute each number into the appropriate bucket.
Sort the numbers in each bucket using any sorting algorithm. Concatenate the sorted even and odd buckets to get the final sorted array.
Approach:
...
function bucketSort(arr) {
  // Buckets for even and odd numbers
  let evenBucket = [];
  let oddBucket = [];
...
// Test Cases
console.log(bucketSort([4, 2, 6, 9, 7, 5])); // Output: [2, 4, 6, 5, 7, 9]
console.log(bucketSort([9, 8, 7, 6, 5, 4, 3, 2, 1])); // Output: [2, 4, 6, 8, 1, 3, 5, 7, 9]
