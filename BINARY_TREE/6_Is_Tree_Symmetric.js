...
Test Case 1:
Sample Input: 1 2 2 3 4 4 3

Sample Output: The tree is symmetric

Test Case 2:
sample input: 1 2 2 null 3 null 3
...
The comparison should be done level by level, comparing the corresponding nodes. Use a recursive approach to check if the subtrees are symmetric.
Approach:
