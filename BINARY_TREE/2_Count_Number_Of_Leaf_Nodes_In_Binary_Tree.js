...
Test Case 1:
Sample Input: 1 2 3 4 5 null 6

Sample Output: 3

Test Case 2:
sample input: 1 null 2 3 null null null

sample output: 2

Level: Easy
Hints:
Traverse the binary tree using a suitable traversal algorithm. At each node, check if it is a leaf node (i.e., both left and right children are null).
If a node is a leaf node, increment the count. Continue the traversal until all nodes have been visited.
Approach:
